...
const MyThing = <F extends string, T extends Array<{value: F, label: string}>>(foo: [...T]) => {
    return null as any as T[number]["value"];
}

const Nowai = MyThing([{value: "thing", label: "Thing"}, {value: "bar", label: "Bar"}]);
