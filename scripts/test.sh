...
capture_stdout_and_stderr_if_successful packages/reactivated/node_modules/.bin/tslint -p packages/reactivated
capture_stdout_and_stderr_if_successful packages/reactivated/node_modules/.bin/prettier --ignore-path .gitignore --check '**/*.{ts,tsx,yaml,json}'
cd $PWD
